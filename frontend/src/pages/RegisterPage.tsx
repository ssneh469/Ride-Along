    ...
    <div className="min-h-screen flex items-center justify-center px-6 pt-24 relative overflow-hidden">
      ...
      >
        <div className="text-center mb-8">
          ...
          <p className="text-white/40 mt-2">Create an account to start your journey</p>
        </div>
        ...
        <GlassCard className="p-8" variant="dark">
          ...
          <div className="mt-8 pt-6 border-t border-white/5 text-center">
            <p className="text-sm text-white/40">
              ...
              <Link to="/login" className="text-primary-mid font-bold hover:underline">Sign In</Link>
            </p>
          </div>
        </GlassCard>
      </motion.div>
